...
export class ProfileResolver {
  ...
  @Mutation(() => AvatarUploadUrlResponse)
  generateAvatarUploadUrl(@CurrentUser() user: CurrentUserPayload) {
    return this.profileService.generateAvatarUploadUrl(user.userId);
  }
  ...
  updateAvatar(
    ...
    return this.profileService.updateAvatar(user.userId, input);
  }
